...
function setStreams(streams: Stream[]) {
    ...
    streams.forEach(item => {
        ...
        <a class="stream-item" href="${item.link}">
            <img class="stream-item__logo" src="${item.logo}" alt="Logo" />
            <section class="stream-item__content">
                <span class="stream-item__name">${item.name}asjkdhajkhsdahdashdjkhahdahsdhasdsajdaskdhakhdshadhasdh</span>
